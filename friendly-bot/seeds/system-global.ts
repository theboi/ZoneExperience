    ...
    next_flows: [
      ...
      },
      {
        ...
        actions: [
          {
            type: "send_message",
            text: "we have different youth groups for different ages! which are you referring to?"
          },
          {
        ...
        next_flows: [
          {
            ...
            actions: [
              {
                type: "send_message",
                text: "DARE services are held on DARE_SERVICE_DAY. Doors open at DARE_DOORS_OPEN_TIME, service starts at DARE_SERVICE_START_TIME, and ends at DARE_SERVICE_END_TIME at DARE_SERVICE_VENUE."
              }
            ],
            next_flow_mode: "ALLOW_MANY",
            return_actions: [],
          ...
          },
          {
            ...
            actions: [
              {
                type: "send_message",
                text: "Arrow services are held on ARROW_SERVICE_DAY. Doors open at ARROW_DOORS_OPEN_TIME, service starts at ARROW_SERVICE_START_TIME, and ends at ARROW_SERVICE_END_TIME at ARROW_SERVICE_VENUE."
              }
            ],
            next_flow_mode: "ALLOW_MANY",
            return_actions: [],
          ...
          },
          {
            ...
            actions: [
              {
                type: "send_message",
                text: "Varsity services are held on VARSITY_SERVICE_DAY. Doors open at VARSITY_DOORS_OPEN_TIME, service starts at VARSITY_SERVICE_START_TIME, and ends at VARSITY_SERVICE_END_TIME at VARSITY_SERVICE_VENUE."
              }
            ],
            next_flow_mode: "ALLOW_MANY",
            return_actions: [],
          ...
          },
          {
            ...
            trigger: {
              type: "message",
              llm_gist: "The person answers the current youth-group timing question with a group other than Dare, Arrow, or Varsity."
            },
            actions: [
              {
                type: "send_message",
                text: "I have timing details for Dare, Arrow, and Varsity. Which of these groups did you mean?"
              }
            ],
            next_flow_mode: "ALLOW_MANY",
            return_actions: [],
      ...
      },
      {
        ...
        actions: [
          {
            type: "send_message",
            text: "The next gathering is NEXT_GATHERING_DATE at NEXT_GATHERING_TIME. Please add the current event calendar or link: UPCOMING_EVENTS_LINK."
          }
        ],
        next_flow_mode: "ALLOW_MANY",
        return_actions: [],
      ...
      },
      {
        ...
        actions: [
          {
            type: "send_message",
            text: "A typical service lasts SERVICE_DURATION. Please update this if it differs for the service you mean."
          }
        ],
        next_flow_mode: "ALLOW_MANY",
        return_actions: [],
      ...
      },
      {
        ...
        actions: [
          {
            type: "send_message",
            text: "Please check OFFICIAL_UPDATES_LINK for the latest service updates, or contact OFFICIAL_UPDATES_CONTACT."
          }
        ],
        next_flow_mode: "ALLOW_MANY",
        return_actions: [],
      ...
      },
      {
        ...
        actions: [
          {
            type: "send_message",
            text: "NCC is New Creation Church. Please add a short approved description here: NCC_DESCRIPTION."
          }
        ],
        next_flow_mode: "ALLOW_MANY",
        return_actions: [],
      ...
      },
      {
        ...
        actions: [
          {
            type: "send_message",
            text: "Growing up and trying to stay afloat amidst endless homework and responsibilities? Come face to face with the One who wants to calm the storms in your life and be the anchor of your soul. DARE is a place where you will discover your purpose and meet authentic friends who will never let you walk alone. #DAREishome (for secondary school students aged 13-17yo)"
          },
          {
            type: "send_message",
            text: "Follow us at @nccdare on Instagram for latest updates on service dates and timings."
          }
        ],
        next_flow_mode: "ALLOW_MANY",
        return_actions: [],
      ...
      },
      {
        ...
        actions: [
          {
            type: "send_message",
            text: "Ok, you're in a new season and the world's your oyster. Wondering what the future holds? We know that God will use this season to prepare and set you up for all the plans and the purposes He has for you. Because #ArrowIsFamily—you don't have to act, dress or talk in a certain way to belong. You can come as you are. We believe that the message of Jesus will radically transform your life. Come and discover His perfect love for you.  (for post-secondary school students and NSFs aged 17-23yo)"
          },
          {
            type: "send_message",
            text: "Follow us at @nccarrow on Instagram for latest updates on service dates and timings."
          }
        ],
        next_flow_mode: "ALLOW_MANY",
        return_actions: [],
      ...
      },
      {
        ...
        actions: [
          {
            type: "send_message",
            text: "Whether you've got a packed semester, an intense elective, or a chill internship—your university experience is shaped by the people you're surrounded with. At V, we are committed to taking this journey together with unstoppable faith and irresistible wisdom. We crave intimate and real relationships with Jesus and with each other. We are a fam that will never let you walk through life alone. (for university students)"
          },
          {
            type: "send_message",
            text: "Follow us at @nccvarsity on Instagram for latest updates on service dates and timings."
          }
        ],
        next_flow_mode: "ALLOW_MANY",
        return_actions: [],
      ...
      },
      {
        ...
        trigger: {
          ...
          possible_qns: [
            ...
            "can primary school/secondary school/junior college/JC/Poly/Polytechnic students come?"
          ]
        },
        actions: [
          {
            type: "send_message",
            text: "The Zone consists of three youth groups designed for students and NSF aged 13-25yo. If you are a working adult, you can join our English care groups and find support for the season you are in!"
          },
          {
            type: "send_message_fixed",
            text: "DARE: for secondary school students aged 13-17yo\nArrow: for post-secondary school students and NSFs aged 17-23yo\nVarsity: for university students"
      ...
      },
      {
        ...
        actions: [
          {
            type: "send_message",
            text: "You are welcome at The Zone whether or not you are Christian. You can come, ask questions, and take things at your own pace."
          }
        ],
        next_flow_mode: "ALLOW_MANY",
        return_actions: [],
      ...
      },
      {
        ...
        actions: [
          {
            type: "send_message",
            text: "The Zone is a place to meet people, explore faith, and grow in community. Please add the approved purpose statement here: THE_ZONE_PURPOSE."
          }
        ],
        next_flow_mode: "ALLOW_MANY",
        return_actions: [],
      ...
      },
      {
        ...
        actions: [
          {
            type: "send_message",
            text: "The Zone costs COST_OR_FREE_DETAILS. Please add any event-specific price, payment, or financial-help details here."
          }
        ],
        next_flow_mode: "ALLOW_MANY",
        return_actions: [],
